...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Library/Frameworks/Python.framework/Versions/3.8/lib -ltcl8.6'
...
TCL_PACKAGE_PATH='/Library/Frameworks/Python.framework/Versions/3.8/lib /usr/local/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Library/Frameworks/Python.framework/Versions/3.8/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/private/tmp/_py/_bld/tcl8.6.8/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Library/Frameworks/Python.framework/Versions/3.8/lib/libtclstub8.6.a'
